...
from convertor import cartesian_to_homogeneous
from normalize import compute_essential_normalized_matrix, compute_P_from_essential, reconstruct_one_point, triangulation
...
def process(img):
	...
	points1 = cartesian_to_homogeneous(pts1)
	points2 = cartesian_to_homogeneous(pts2)
	...
	if points1.ndim != 1 or points2.ndim != 1:
		...
		E = compute_essential_normalized_matrix(points1_norm, points2_norm)
